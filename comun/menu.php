<div class="navbar-wrapper" id="menu_principal" style="opacity:0">
      <div class="container">
      <div class="col-lg-2" >
          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="http://getbootstrap.com/examples/carousel/#">
                  Inicio
                </a></li>
                <li><a href="http://getbootstrap.com/examples/carousel/#about">Sobre Nosotros</a></li>
                <li><a href="http://getbootstrap.com/examples/carousel/#contact">Comentarios</a></li>
                <li class="dropdown">
